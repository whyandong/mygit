...
# logging.debug(ulog.log_file_dir)

constant.write_result_temp_dir = ulog.log_root_path
# logging.debug(ulog.log_root_path)
...
if args.id:
    ...
    if args.source is None:
        ...
        source_info = constant.unionTest_config['transform'].get(
            args.source, None)
...
if args.mark:
    pytest_args = [
        "-m", " ".join(args.mark), "-sq", "--alluredir",
        constant.allure_results_path
    ]
